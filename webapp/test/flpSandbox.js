		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#combankdetailsmybankdetails1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"combankdetailsmybankdetails1-display": {
								"semanticObject": "combankdetailsmybankdetails1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.bankdetails.mybankdetails1",
									"url": sap.ui.require.toUrl("com/bankdetails/mybankdetails1")
								}
							}
						}
					}
